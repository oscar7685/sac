...
public class HorarioController {
    ...
    public void find(HttpServletRequest httpRequest, HttpServletResponse httpServletResponse) throws IOException {
        try {
            List<Horario> a2 = horarioDAO.findAll();
    ...
    public void read(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @PathVariable("idHorario") int idHorario) {
        try {
            Horario a = horarioDAO.get(idHorario);
    ...
    @RequestMapping(value = "/Horario/{idHorario}", method = RequestMethod.PUT, consumes = "application/json", produces = "application/json")
    public void update(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @RequestBody String jsonEntrada, @PathVariable("idHorario") int idHorario) {
        try {
            Horario aux = (Horario) jsonTransformer.fromJson(jsonEntrada, Horario.class);
            horarioDAO.saveOrUpdate(aux);
    ...
    @RequestMapping(value = "/Horario", method = RequestMethod.POST, consumes = "application/json", produces = "application/json")
    public void insert(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @RequestBody String jsonEntrada) {
        try {
            Horario aux2 = (Horario) jsonTransformer.fromJson(jsonEntrada, Horario.class);
            horarioDAO.saveOrUpdate(aux2);
